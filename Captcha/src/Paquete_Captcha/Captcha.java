...
public final class Captcha
{
    ...
    /**
     * Genera un captcha compuesto de números y letras.
     * 
     * @param N Longitud del captcha a generar.
     * @return Una cadena de texto con números y letras aleatorios de longitud N.
     */
    
    public final static String GenerarCaptchaCombinados (int N)
    {
        String caracteres = "0123456789ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789";
        StringBuilder captcha = new StringBuilder();
        Random rand = new Random();
        for (int x = 0; x < N; x++) 
        {
