...
public class Prueba_Equipo14 extends javax.swing.JFrame 
{
    ...
    public Prueba_Equipo14() 
    {
        ...
        CaptchaObjeto.Restricciones_TxT(txtCaptcha, 2);
        CaptchaObjeto.Restricciones_TxT(txtCaptchaLongitud, 1);
    }
    ...
    private void btnAceptarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAceptarActionPerformed
        ...
        if(!CaptchaObjeto.ValidarCaptcha(txtCaptcha.getText(), CaptchaGenerado, lblResultado))
        {
            ...
            {
                CaptchaGenerado = CaptchaObjeto.GenerarCaptcha( Integer.parseInt(txtCaptchaLongitud.getText()),1);
                ImagenCaptcha = CaptchaObjeto.CrearImagen(CaptchaGenerado);
            }
            if(rdbtSoloLetras.isSelected())
            {
                CaptchaGenerado = CaptchaObjeto.GenerarCaptcha( Integer.parseInt(txtCaptchaLongitud.getText()),2);
                ImagenCaptcha = CaptchaObjeto.CrearImagen(CaptchaGenerado);
            }
            if(rdbtCombinado.isSelected())
            {
                CaptchaGenerado =CaptchaObjeto.GenerarCaptcha( Integer.parseInt(txtCaptchaLongitud.getText()),3);
                ImagenCaptcha = CaptchaObjeto.CrearImagen(CaptchaGenerado);
            }
